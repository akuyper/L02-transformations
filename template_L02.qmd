...
::: callout-warning
To make your solution output readable, you should select only relevant columns and slice a few observations, where appropriate. That way the entire data frame is not being printed.
:::
